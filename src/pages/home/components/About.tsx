    ...
    <section className="py-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-serif text-black mb-8 leading-tight">
          A Community of <span className="text-primary">Change-Makers</span>:{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="transform rotate-1 hover:rotate-0 transition-transform">
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Recognized for outstanding contribution to IEEE activities and student engagement
            ...
            <div className="transform -rotate-1 hover:rotate-0 transition-transform">
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Achieved gold recognition for exceptional leadership and innovation in student
                  branch activities.
                </p>
              </div>
            </div>
            ...
            <div className="transform rotate-2 hover:rotate-0 transition-transform">
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Winner of the global IEEE Day STEM photography competition showcasing innovation
                  in action.
                </p>
              </div>
            </div>
