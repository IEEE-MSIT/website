      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Find answers to the most common questions about IEEE MSIT chapter, membership, and our activities.
          </p>
        </div>
            ...
            >
              ...
              >
                ...
                <div className={`flex-shrink-0 transition-all duration-300 ${
                  openIndex === index ? 'rotate-180 text-primary' : 'text-gray-400 group-hover:text-primary'
                }`}>
                  {openIndex === index ? (
