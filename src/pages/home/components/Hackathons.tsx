        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
            ...
            {hackathons.past.map((hackathon, index) => (
              <div
                key={index}
                className="group bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-xl hover:border-primary transition-all duration-500 h-full"
              >
                  ...
                  <div className="flex items-start justify-between mb-4 md:mb-6">
                    ...
                    <div className="text-right">
                      <a
                          ...
                          className="flex items-center justify-center  gap-1 bg-blue-100 text-blue-700 px-2 py-1 rounded-full text-xs font-medium hover:bg-blue-200 transition-colors"
                        >
