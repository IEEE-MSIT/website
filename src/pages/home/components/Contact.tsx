...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      details: [
        ...
        'Quick responses and announcements'
      ],
      action: 'Join Group'
    }
  ];
  ...
  return (
    <section id="contact" className="py-20 px-4 md:px-6 bg-gradient-to-br from-primary/5 to-primary/10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Have questions about IEEE MSIT? Want to join our community or collaborate with us? 
