  ...
  const faqData: FAQItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        answer:
          'We conduct events regularly throughout the academic year. On average, we organize 2-3 major events per month, including workshops, seminars, competitions, and social gatherings. We also have ongoing projects and study groups that meet weekly.',
        category: 'Events',
      },
      {
        question: 'What is the selection process for IEEE MSIT executive positions?',
        answer:
          'Executive positions are filled through a democratic process involving nominations and elections. Interested members can nominate themselves or be nominated by others. The selection is based on leadership skills, commitment to IEEE values, academic performance, and contribution to the chapter.',
        category: 'Leadership',
      },
      {
        question: 'Does IEEE MSIT provide internship or job placement assistance?',
        answer:
          'Yes, we provide career guidance through our industry connect programs, alumni networking events, resume building workshops, and interview preparation sessions. We also share internship and job opportunities through our communication channels.',
        category: 'Career',
      },
      {
        question: 'What are the different societies within IEEE MSIT?',
        answer:
          'IEEE MSIT has several specialized societies: Computer Society (CS), Robotics and Automation Society (RAS), Power and Energy Society (PES), and Women in Engineering (WIE). Each society focuses on specific technical domains and organizes targeted events and activities.',
        category: 'General',
      },
      {
        question: 'Can I participate in IEEE competitions and conferences?',
        answer:
          'Absolutely! IEEE MSIT encourages and supports members to participate in regional, national, and international IEEE competitions, conferences, and technical paper presentations. We provide guidance, resources, and sometimes financial support for worthy participants.',
        category: 'Events',
      },
      {
        question: 'How can I stay updated with IEEE MSIT activities?',
        answer:
          'You can stay updated through our official website, social media channels (Instagram, LinkedIn, Twitter), WhatsApp groups, email newsletters, and notice boards on campus. We also have society-specific newsletters like SHESCRIPTS (WIE) and ROBO TIDING (RAS).',
        category: 'General',
      },
      {
        question: 'What are the leadership development opportunities in IEEE MSIT?',
        answer:
          'IEEE MSIT offers numerous leadership opportunities including executive committee positions, event organization roles, mentorship programs, technical project leadership, and representation at regional IEEE events. We also conduct leadership workshops and soft skills training.',
        category: 'Leadership',
      },
      {
        question: 'Does IEEE MSIT collaborate with industry partners?',
        answer:
          'Yes, we have strong industry partnerships with leading tech companies. These collaborations result in guest lectures, industrial visits, internship opportunities, sponsored events, and real-world project opportunities for our members.',
        category: 'Career',
      },
      {
        question: "How can I contribute to IEEE MSIT if I'm a new member?",
        answer:
          'New members can contribute by attending events, volunteering for activities, joining committees, participating in projects, sharing ideas for events, helping with social media, and bringing innovative suggestions. Every contribution, no matter how small, is valued and recognized.',
        category: 'Membership',
      },
    ],
    []
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Our team is here to help! Reach out to us directly and we'll get back to you as soon
              as possible.
            </p>
