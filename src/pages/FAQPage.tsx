...
const FAQPage = () => {
  ...
  const faqData: FAQItem[] = useMemo(() => [
    ...
    },
    {
      ...
      answer: "IEEE membership provides networking opportunities with industry professionals, access to cutting-edge research, professional development resources, certification programs, and career guidance. Many companies value IEEE involvement when hiring, and it demonstrates your commitment to professional growth.",
      category: "Career"
    },
    {
      question: "What is the IEEE MSIT executive committee structure?",
      answer: "Our executive committee typically includes positions like Chairperson, Vice-Chairperson, Secretary, Treasurer, Technical Head, Event Coordinator, and Public Relations Head. Elections are held annually, and all active members can participate in the democratic process.",
      category: "Organization"
    },
    {
      question: "How often are meetings and events conducted?",
      answer: "We conduct regular monthly meetings and organize events throughout the academic year. Major events happen 2-3 times per semester, while workshops and technical sessions are more frequent. We also have online sessions and webinars to ensure continuous engagement.",
      category: "Events"
    },
    {
      question: "Can I contribute to IEEE MSIT even if I'm in my first year?",
      answer: "Definitely! We encourage participation from students of all years. First-year students can join as volunteers, participate in events, contribute ideas, and gradually take on more responsibilities. Many of our successful leaders started their journey in their first year.",
      category: "General"
    },
    {
      question: "How do I access IEEE digital resources and library?",
      answer: "As an IEEE member, you get free access to IEEE Xplore Digital Library, which contains millions of technical documents including research papers, conference proceedings, and standards. You can access it through the IEEE website using your member credentials.",
      category: "Resources"
    },
    {
      question: "What chapters are available at IEEE MSIT?",
      answer: "IEEE MSIT hosts multiple technical chapters including Computer Society, Women in Engineering (WIE), Power & Energy Society (PES), Robotics & Automation Society (RAS), Industry Applications Society, and Communications Society. Each chapter focuses on specific technical domains.",
      category: "Organization"
    },
    {
      question: "How can I volunteer for IEEE MSIT events?",
      answer: "You can volunteer by contacting our executive committee, joining our WhatsApp group for announcements, or reaching out during our recruitment drives. We always welcome enthusiastic volunteers for various roles including event management, technical coordination, and publicity.",
      category: "Volunteering"
    },
    {
      question: "Does IEEE MSIT provide certification courses?",
      answer: "Yes, we regularly organize certification workshops and training sessions in collaboration with industry partners. These cover topics like programming languages, emerging technologies, soft skills, and professional development. Members get priority access and discounted rates.",
      category: "Learning"
    },
    {
      question: "How can I submit a technical paper or present my research?",
      answer: "IEEE MSIT regularly organizes paper presentation sessions and research symposiums. You can submit your abstracts during our call for papers announcements. We also help students submit papers to IEEE conferences and journals with mentorship from faculty advisors.",
      category: "Research"
    }
  ], []);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Find comprehensive answers to all your questions about IEEE MSIT chapter, membership, events, and opportunities.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-primary/5 via-secondary/5 to-primary/5 rounded-2xl p-8 border border-primary/10">
              ...
              <p className="text-gray-600 mb-6">
                Can't find what you're looking for? Our team is here to help you with any questions about IEEE MSIT.
              </p>
