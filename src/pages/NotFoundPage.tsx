...
const NotFoundPage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-cream text-center px-6">
      <h1 className="text-6xl md:text-9xl font-serif text-accent-red font-bold">404</h1>
      ...
      <Link to={HOME_PATH} className="bg-black text-white px-8 py-4 rounded-full hover:bg-gray-800 transition-colors font-medium shadow-lg hover:shadow-xl">
        Go to Homepage
      </Link>
    </div>
  );
