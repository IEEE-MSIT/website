...
export const sampleHackathon: Event = {
  ...
  description:
    'Join us for a 48-hour coding marathon where innovation meets creativity. Build groundbreaking solutions for real-world problems and compete for exciting prizes worth ₹2 Lakhs+',
  ...
  media: {
    ...
    gallery: ['/events/hackathon-2024-1.jpg', '/events/hackathon-2024-2.jpg'],
  ...
  seo: {
    ...
    metaDescription:
      "Join IEEE MSIT's premier hackathon with ₹2L+ prizes. Build innovative tech solutions in AI, blockchain, and more. Free registration for students.",
...
export const sampleWorkshop: Event = {
  ...
  description:
    'A comprehensive hands-on workshop covering React fundamentals, components, state management, and building a complete web application.',
...
export const sampleConference: Event = {
  ...
  description:
    'Annual conference featuring latest research in technology, innovation showcases, and networking opportunities with industry leaders.',
